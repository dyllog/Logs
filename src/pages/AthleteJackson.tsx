...
const RESULTS = [
  { dateNum: 2014 + 10/12, year: 2014, race: 'Auckland Half Marathon',      short: 'AKL Half', dist: '21.1 km', distId: 'half' as const, time: '1:09:01', sec: 4141, pos: 3,  total: 7125, cat: 'M 20–39', isPB: false },
  { dateNum: 2015 + 4/12,  year: 2015, race: 'Rotorua Marathon',            short: 'ROT',      dist: '42.2 km', distId: 'mar'  as const, time: '2:30:25', sec: 9025, pos: 3,  total: 1172, cat: 'M 20–39', isPB: false },
  ...
  { dateNum: 2019 + 4/12,  year: 2019, race: 'Rotorua Half Marathon',       short: 'ROT Half', dist: '21.1 km', distId: 'half' as const, time: '1:13:44', sec: 4424, pos: 1,  total:  720, cat: 'M 20–39', isPB: false },
  { dateNum: 2019 + 5/12,  year: 2019, race: 'Christchurch Half Marathon',  short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:09:47', sec: 4187, pos: 5,  total: 1504, cat: 'M 20–39', isPB: false },
  { dateNum: 2019 + 10/12, year: 2019, race: 'Auckland Half Marathon',      short: 'AKL Half', dist: '21.1 km', distId: 'half' as const, time: '1:11:10', sec: 4270, pos: 8,  total: 5204, cat: 'M 20–39', isPB: false },
  ...
  { dateNum: 2026 + 4.5/12,year: 2026, race: "Hawke's Bay Marathon",        short: 'HB',       dist: '42.2 km', distId: 'mar'  as const, time: '2:33:49', sec: 9229, pos: 7,  total: 1126, cat: 'M 35–39', isPB: false },
];
...
export default function AthleteJackson() {
      ...
      <section style={{ background: 'var(--surface-dark)', color: 'var(--on-dark)', padding: '48px 0 40px', borderBottom: '0.5px solid var(--on-dark-rule)' }}>
        <div className="page">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'start' }} className="athlete-head-grid">
            <div>
              <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(255,255,255,0.1)', border: '0.5px solid rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20, fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 18, letterSpacing: '-0.01em', color: 'var(--on-dark)' }}>JJ</div>
              <h1 className="serif" style={{ fontSize: 'clamp(36px,5vw,60px)', lineHeight: 0.96, margin: 0, letterSpacing: '-0.025em', color: 'var(--on-dark)' }}>Jonathan Jackson</h1>
          ...
          <div style={{ marginTop: 32, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button className="btn" style={{ color: 'var(--on-dark)', borderColor: 'var(--on-dark)', fontSize: 10.5 }}
                    onClick={() => navigate('/athletes/jonathan-jackson/report')}>
              View Report →
            </button>
          </div>
        </div>
      ...
      <section className="section">
        <div className="page">
          <div className="section-header">
            ...
            <div className="dimmed" style={{ fontSize: 12 }}>2014–2026 · AKL · CHC · ROT · QT · WF · HB</div>
          </div>
