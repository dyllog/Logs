...
const RESULTS = [
  { dateNum: 2019 + 5/12,  year: 2019, race: 'Wellington Marathon',  short: 'WEL', dist: '42.2 km', distId: 'mar' as const, time: '2:27:12', sec: 8832, pos: 1,  total: 349,  cat: 'M 30–39', isPB: true  },
  ...
  { dateNum: 2022 + 4.5/12,year: 2022, race: "Hawke's Bay Marathon", short: 'HB',  dist: '42.2 km', distId: 'mar' as const, time: '2:29:17', sec: 8957, pos: 2,  total: 415,  cat: 'M 30–39', isPB: false },
...
const PBs = {
  mar: { time: '2:27:12', sec: 8832, race: 'Wellington Marathon', year: 2019 },
};
      ...
      <section style={{ background: 'var(--surface-dark)', color: 'var(--on-dark)', padding: '48px 0 40px', borderBottom: '0.5px solid var(--on-dark-rule)' }}>
        <div className="page">
          ...
          <div style={{ marginTop: 32, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button className="btn" style={{ color: 'var(--on-dark)', borderColor: 'var(--on-dark)', fontSize: 10.5 }}
                    onClick={() => navigate('/athletes/hiro-tanimoto/report')}>
              View Report →
            </button>
          </div>
        </div>
            ...
            <div>
              ...
              <div style={{ background: 'var(--surface-dark)', padding: '24px 20px 16px' }}>
                ...
                <div style={{ marginTop: 8, fontSize: 10, color: 'var(--on-dark-meta)', fontStyle: 'italic', textAlign: 'right', fontFamily: "'DM Serif Display', Georgia, serif" }}>
                  Wellington (Jun), Hawke's Bay (Jun) and Queenstown (Nov) shown at separate dates
                </div>
              </div>
