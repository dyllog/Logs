...
const RESULTS = [
  ...
  { dateNum: 2023 + 11/12, year: 2023, race: 'Omaha Half Marathon',      short: 'OMAHA', dist: '21.1 km', distId: 'half' as const, time: '1:16:53', sec: 4613,  pos: 1,  total: 1147, cat: 'M 20–29', isPB: false },
  ...
  { dateNum: 2024 + 11/12, year: 2024, race: 'Omaha Half Marathon',      short: 'OMAHA', dist: '21.1 km', distId: 'half' as const, time: '1:19:19', sec: 4759,  pos: 3,  total: 1144, cat: 'M 20–29', isPB: false },
        ...
        <div className="page">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 48, alignItems: 'start' }} className="overview-grid">
            ...
            <div>
              ...
              {[
                { label: 'Races logged',     val: '14',      sub: '4 marathons · 9 halves · 1 10k' },
                ...
                { label: 'Active years',     val: '7',       sub: '2020–2026 · AUC · COAST · DEV · OMAHA · WF · CHC' },
              ].map((s, i) => (
      ...
      <section className="section">
        <div className="page">
          <div className="section-header">
            ...
            <div className="dimmed" style={{ fontSize: 12 }}>2020–2026 · AUC · COAST · DEV · OMAHA · WF · CHC</div>
          </div>
                ...
                {sortedResults.map((r, i) => (
                  <tr key={i} className="row"
                      onClick={() => {
                        ...
                        else if (r.race.includes('Omaha')) navigate(`/races/omaha-half-marathon?year=${r.year}&dist=${d}`);
                      }}>
          ...
          <div className="dimmed mt-16" style={{ fontSize: 11, lineHeight: 1.6 }}>
            Percentile computed across all finishers in that event and year. Results sourced from Auckland, Christchurch, Coatesville, Devonport, Omaha and Waterfront certified timings.
          </div>
        </div>
      </section>
    </main>
