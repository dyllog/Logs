...
function AthletesCanvas({
  ...
  // Local query state — what the user is currently typing.
  // Kept separate from h2hA/h2hB (the committed selections) so that
  // keystrokes don't trigger findAthlete on every character.
