...
const RESULTS = [
  { dateNum: 2013 + 5/12,  year: 2013, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:06:11', sec: 3971, pos: 3,  total: 1948, cat: 'M 20–39', isPB: true  },
  { dateNum: 2014 + 5/12,  year: 2014, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:06:45', sec: 4005, pos: 4,  total: 1589, cat: 'M 20–39', isPB: false },
  { dateNum: 2015 + 5/12,  year: 2015, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:06:15', sec: 3975, pos: 5,  total: 2038, cat: 'M 20–39', isPB: false },
  { dateNum: 2015 + 10/12, year: 2015, race: 'Auckland Marathon',          short: 'AKL',      dist: '42.2 km', distId: 'mar'  as const, time: '2:27:01', sec: 8821, pos: 1,  total: 1507, cat: 'M 20–39', isPB: true  },
  { dateNum: 2016 + 5/12,  year: 2016, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:06:34', sec: 3994, pos: 2,  total: 1786, cat: 'M 20–39', isPB: false },
  { dateNum: 2017 + 5/12,  year: 2017, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:08:01', sec: 4081, pos: 2,  total: 1579, cat: 'M 20–39', isPB: false },
  { dateNum: 2017 + 10/12, year: 2017, race: 'Auckland Half Marathon',     short: 'AKL Half', dist: '21.1 km', distId: 'half' as const, time: '1:07:18', sec: 4038, pos: 1,  total: 5706, cat: 'M 20–39', isPB: false },
  { dateNum: 2018 + 5/12,  year: 2018, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:06:24', sec: 3984, pos: 2,  total: 1574, cat: 'M 20–39', isPB: false },
...
export default function AthletePulford() {
      ...
      <section style={{ background: 'var(--surface-dark)', color: 'var(--on-dark)', padding: '48px 0 40px', borderBottom: '0.5px solid var(--on-dark-rule)' }}>
        <div className="page">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'start' }} className="athlete-head-grid">
            <div>
              <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(255,255,255,0.1)', border: '0.5px solid rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20, fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 18, letterSpacing: '-0.01em', color: 'var(--on-dark)' }}>AP</div>
              <h1 className="serif" style={{ fontSize: 'clamp(36px,5vw,60px)', lineHeight: 0.96, margin: 0, letterSpacing: '-0.025em', color: 'var(--on-dark)' }}>Aaron Pulford</h1>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 0, background: 'var(--on-dark-rule)', border: '0.5px solid var(--on-dark-rule)' }} className="pb-grid">
              {[
                ...
                { dist: '21.1 km', pb: PBs.half.time, race: 'Christchurch Half Marathon',  year: PBs.half.year, highlight: true  },
          ...
          <div style={{ marginTop: 32, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button className="btn" style={{ color: 'var(--on-dark)', borderColor: 'var(--on-dark)', fontSize: 10.5 }}
                    onClick={() => navigate('/athletes/aaron-pulford/report')}>
              View Report →
            </button>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 260px', gap: 48, alignItems: 'start' }} className="overview-grid">
            <div>
              ...
              <div style={{ display: 'flex', gap: 20, marginTop: 16, fontSize: 11, color: 'var(--meta)' }}>
                ...
                <span style={{ fontFamily: "'DM Mono', monospace" }}>
                  {chartDist === 'mar'
                    ? `${marResults.length} finish · ${Math.min(...marResults.map(r=>r.year))}`
            ...
            <div>
              ...
              <div style={{ marginTop: 20 }}>
                <div className="label mb-12">Half marathon times</div>
                {halfResults.sort((a,b) => b.dateNum - a.dateNum).map((r, i, arr) => {
      ...
      <section className="section">
        <div className="page">
          <div className="section-header">
            ...
            <div className="dimmed" style={{ fontSize: 12 }}>2013–2020 · AKL · CHC · ROT</div>
          </div>
