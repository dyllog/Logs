...
const RESULTS = [
  { dateNum: 2012 + 5/12,  year: 2012, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:11:19', sec: 4279, pos: 10, total: 1800, cat: 'M 20–39', isPB: false },
  { dateNum: 2015 + 11/12, year: 2015, race: 'Queenstown Half Marathon',   short: 'QT Half',  dist: '21.1 km', distId: 'half' as const, time: '1:14:18', sec: 4458, pos: 1,  total: 4000, cat: 'M 20–29', isPB: false },
  { dateNum: 2016 + 11/12, year: 2016, race: 'Queenstown Half Marathon',   short: 'QT Half',  dist: '21.1 km', distId: 'half' as const, time: '1:15:50', sec: 4550, pos: 3,  total: 4200, cat: 'M 20–29', isPB: false },
  { dateNum: 2017 + 5/12,  year: 2017, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:10:12', sec: 4212, pos: 4,  total: 2500, cat: 'M 20–39', isPB: false },
  { dateNum: 2017 + 11/12, year: 2017, race: 'Queenstown Half Marathon',   short: 'QT Half',  dist: '21.1 km', distId: 'half' as const, time: '1:12:22', sec: 4342, pos: 4,  total: 4500, cat: 'M 20–29', isPB: false },
  { dateNum: 2020 + 11/12, year: 2020, race: 'Queenstown Half Marathon',   short: 'QT Half',  dist: '21.1 km', distId: 'half' as const, time: '1:12:54', sec: 4374, pos: 2,  total: 4418, cat: 'M 20–29', isPB: false },
  { dateNum: 2021 + 5/12,  year: 2021, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:15:24', sec: 4524, pos: 17, total: 2600, cat: 'M 20–39', isPB: false },
  { dateNum: 2023 + 11/12, year: 2023, race: 'Queenstown Half Marathon',   short: 'QT Half',  dist: '21.1 km', distId: 'half' as const, time: '1:14:48', sec: 4488, pos: 3,  total: 4200, cat: 'M 30–39', isPB: false },
  { dateNum: 2024 + 11/12, year: 2024, race: 'Queenstown Half Marathon',   short: 'QT Half',  dist: '21.1 km', distId: 'half' as const, time: '1:12:25', sec: 4345, pos: 6,  total: 4828, cat: 'M 30–34', isPB: false },
  { dateNum: 2026 + 5/12,  year: 2026, race: 'Christchurch Half Marathon', short: 'CHC Half', dist: '21.1 km', distId: 'half' as const, time: '1:09:46', sec: 4186, pos: 11, total: 3456, cat: 'M 35–39', isPB: true  },
];

const PBs = {
  half: { time: '1:09:46', sec: 4186, race: 'Christchurch Half Marathon', year: 2026 },
};
...
export default function AthleteMikePhillips() {
      ...
      <section style={{ background: 'var(--surface-dark)', color: 'var(--on-dark)', padding: '48px 0 40px', borderBottom: '0.5px solid var(--on-dark-rule)' }}>
        <div className="page">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'start' }} className="athlete-head-grid">
            <div>
              <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(255,255,255,0.1)', border: '0.5px solid rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20, fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 18, letterSpacing: '-0.01em', color: 'var(--on-dark)' }}>MP</div>
              <h1 className="serif" style={{ fontSize: 'clamp(36px,5vw,60px)', lineHeight: 0.96, margin: 0, letterSpacing: '-0.025em', color: 'var(--on-dark)' }}>Mike Phillips</h1>
          ...
          <div style={{ marginTop: 32, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Link to="/athletes/mike-phillips/report" className="btn" style={{ color: 'var(--on-dark)', borderColor: 'var(--on-dark)', fontSize: 10.5 }}>
              View Report →
            </Link>
          </div>
        </div>
      ...
      <section className="section">
        <div className="page">
          <div className="section-header">
            ...
            <div className="dimmed" style={{ fontSize: 12 }}>2012–2026 · QT · CHC</div>
          </div>
