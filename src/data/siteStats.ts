...
export const SITE_STATS = {
  trackedEvents: 7,        // Auckland, Christchurch, Hawke's Bay, Rotorua, Queenstown, Waterfront, Devonport
  finisherRecords: 273434, // sum of all records across public/data/*.json
